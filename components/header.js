...
export default function Header() {
    return (
      <nav id="header" className="absolute w-full z-30 top-0 text-white py-1 lg:py-6">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-2 lg:py-6">
          <div className="pl-4 flex items-center">
            <a
              className="jj-logo text-black no-underline hover:no-underline font-bold text-xl lg:text-xl"
              href="#"
            >
              JUSTJAVASCRIPT
            </a>
